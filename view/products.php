            ...
            <div id="content">
				...
				for($i=0;$i<$rows;++$i)
				{
					...
					$description=$row['description'];
						...
						echo	"<div style='border:solid green 1px;background:#FFFFFF;float:left'>
						<span class='left'><a href='index.php?choice=solopage&code=$code'><img src='view/images/$image' style='width:200px' alt='example graphic' /></a></span>
						<div class='title'>$name</div>
				<p>$description<a href='index.php?choice=solopage&code=$code'>More...</a><br />
